define([ 'jquery', 'knockout', 'text!static/pages/yzqc/bd_demo/griddemo.html' ], function($, ko, template) {

	var infoUrl = "/yzqc/bd_demo/detail/:id";
	
	var addUrl = '/yzqc/bd_demo/detail/0';
	
	var deleteUrl = '/yzqc/bd_demo/delete/';
	
	var pageUrl = '/yzqc/bd_demo/page?page=';
